    ...
    html.Div(children = [
        ...
        html.Div([dcc.Dropdown(id='region-dropdown', 
            options=[{'label': i, 'value': i} for i in regions
                    ], multi=False, clearable=False, value = 'All Regions',optionHeight=25,persistence=True,persistence_type='memory'), 
        ...
        html.Div([dcc.Dropdown(id='year-dropdown', 
            options=[{'label': i, 'value': i} for i in years
                    ], multi=False, clearable=False, value = currentyear,optionHeight=25,persistence=True,persistence_type='memory'), 
        ...
        html.Div([dcc.Dropdown(id='resource-dropdown', 
            options=[{'label': i, 'value': i} for i in resources
                    ], multi=False, clearable=False, value = 'All',optionHeight=25,persistence=True,persistence_type='memory'), 
                 ], style={'padding-top':'0.1%','padding-left':'1%','width':'10%','fontSize':14},className = 'dbc_dark'),
        ...
        html.Div([dcc.Dropdown(id='report-dropdown', 
            options=[{'label': i, 'value': i} for i in report_type
                    ], multi=False, clearable=False, value = 'Throughput',optionHeight=25,persistence=True,persistence_type='memory'), 
                 ], style={'padding-top':'0.1%','padding-left':'1%','width':'10%','fontSize':14,},className = 'dbc_dark'),            
...
# Start of slider
        ...
        html.Div([dcc.Slider(id='week-slider', 
            ...
            ],style={'padding-left': '.1%', 'padding-top':'.3%','width':'85%','margin-bottom':'-7px'},className = 'dbc_dark'),
        ],className =' row'),
# End of slider
        ...
        dbc.Col([
            dbc.Card(html.P(id = 'header5'), color="primary", inverse=True,
                style={'text-align':'center','fontSize':18,'font-weight':'bold',\
                       'margin-left':'1.3%','margin-right':'1.%','margin-bottom':'2px','height':'20px','line-height':'20px',}),
            dbc.Row([
                dbc.Col(
...
# Service Request Section
        dbc.Col([
            dbc.Card(html.P(id = 'header6'), color="primary", inverse=True,
                style={'text-align':'center','fontSize':18,'font-weight':'bold',\
                       'margin-right':'1.5%','margin-bottom':'2px','height':'20px','line-height':'20px',}),
            dbc.Row([
                dbc.Col(
    ...
    dbc.Row([        
        dbc.Col(
            ...
            dbc.Card(html.P('Incident Backlog Age Buckets in Days'), color="primary", inverse=True,
                style={'text-align':'center','fontSize':18,'font-weight':'bold', \
                    'margin-bottom':'2px','height':'20px','line-height':'20px',}),
        ...
        dbc.Col(
            ...
            dbc.Card(html.P('Service Request Backlog Age Buckets in Days'), color="primary", inverse=True,
                style={'text-align':'center','fontSize':18,'font-weight':'bold', \
                    'margin-bottom':'2px','margin-left':'-.3%','height':'20px','line-height':'20px',}),
...
#                    {'if': {'row_index': 'even'}, 'backgroundColor': 'LemonChiffon'},
                ...
                style_header={'border': '1px solid black','fontSize':14, 'font-family':'Calibri', 'backgroundColor': 'red', 'fontWeight': 'bold',
                              'whiteSpace': 'normal', 'height': 'auto', 'color':'white','text-align':'center'},
                style_data ={'border': '1px solid black','lineHeight': '15px','color':'black','text-align':'center','font-weight':'bold','fontSize':14,\
                             'width': '90px','maxWidth': '90px','minWidth': '90px'},
                style_cell={'padding': '5px','fontSize':14, 'font-family':'Calibri',},
                style_cell_conditional=[{'if': {'column_id': 'Ticket Type'},'width': '150px'},],),
...
#                    {'if': {'row_index': 'even'}, 'backgroundColor': 'LemonChiffon'},
                ...
                style_data ={'border': '1px solid black','lineHeight': '15px','color':'black','text-align':'center','font-weight':'bold','fontSize':14,\
                             'width': '90px','maxWidth': '90px','minWidth': '90px'},
                style_cell={'padding': '5px','fontSize':14, 'font-family':'Calibri',},
                style_cell_conditional=[{'if': {'column_id': 'Highest Volume (count)'},'width': '150px'},],),
...
#                    {'if': {'row_index': 'even'}, 'backgroundColor': 'LemonChiffon'},
                ...
                style_header={'border': '1px solid black','fontSize':14, 'font-family':'Calibri', 'backgroundColor': 'red', 'fontWeight': 'bold',
                              'whiteSpace': 'normal', 'height': 'auto', 'color':'white','text-align':'center'},
                style_data ={'border': '1px solid black','lineHeight': '33px','color':'black','text-align':'center','font-weight':'bold','fontSize':14,\
                             'width': '80px','maxWidth': '80px','minWidth': '80px'},
                style_cell={'padding': '5px','fontSize':14, 'font-family':'Calibri',},
                style_cell_conditional=[{'if': {'column_id': 'Ticket Type'},'width': '250px'},],),
            ],style={'margin-bottom':'2px'}), 
...
#                    {'if': {'row_index': 'even'}, 'backgroundColor': 'LemonChiffon'},
                ...
                style_data ={'border': '1px solid black','lineHeight': '15px','color':'black','text-align':'center','font-weight':'bold','fontSize':14,\
                             'width': '80px','maxWidth': '80px','minWidth': '80px'},
                style_cell={'padding': '5px','fontSize':14, 'font-family':'Calibri',},
                style_cell_conditional=[{'if': {'column_id': 'Reason'},'width': '250px'},],),
            ],style={'margin-top':'0px'}), 
